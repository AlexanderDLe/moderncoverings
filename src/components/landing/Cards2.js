        ...
        return {
            multilayered: (
                <Typography className={classes.cardText} color="textSecondary">
                    ...
                    cotton and polyester/rayon-blend filters. We always
                    prioritize quality.
                </Typography>
            ),
            reusable: (
                <Typography className={classes.cardText} color="textSecondary">
                    Each mask is <strong>reusable via proper washing</strong>.
                    We suggest washing with soap then hanging to air-dry. Avoid
                    prolonged heat.
                </Typography>
            ),
            comfortable: (
