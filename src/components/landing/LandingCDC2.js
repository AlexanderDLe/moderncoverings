...
import StoreBG from '../../img/LandingPhotos/StoreBG2.jpg';
...
function LandingCTA({ queryStyles }) {
    ...
    const bgImg = useMemo(() => {
        const img = mediaQuery600
            ? require(`../../img/LandingPhotos/WhiteLadyMask2.jpg`)
            : require(`../../img/LandingPhotos/WhiteLadyMaskPhone2.jpg`);
            ...
            <div className={classes.bgImg} style={bgImg}>
                ...
                >
                    <Container className={classes.container} maxWidth="sm">
                        ...
                        >
                            <strong>
                                We don't sacrifice quality for beautiful
                                designs.
                            </strong>{' '}
                            We have a wide variety available and offer many
                            different categories. From beautiful florals to
                            spectacular patterns, we hope you find what you
                            love!
                        </Typography>
